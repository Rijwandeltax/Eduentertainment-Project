...
<!--/main-header-->
 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner" style="padding:0em; padding-top:2em">
	...
	<?php
				...
				include("enter.php");
				        ...
				        $rs=mysql_query("select * from trandcareer where stream='$v' AND sn=$b");
...
<p><div align="center"><h4><b><?=$r[2]?></b></h4></div></p></div>
     <p ><?=$r[3]?> </p><br />
	 
     <p><i><b>Pre Qualification :</b> <?=$r[5]?></i></p><br />
     <p><b>Enter Exam : </b><?=$r[4]?></p>
     </div>
	 <div class="col-sm-1"></div>
