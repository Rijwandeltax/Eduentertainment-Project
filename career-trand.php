...
<!--/main-header-->
 ...
 <!--//main-header-->
				...
				$b=$_REQUEST["event_id"];
				include("enter.php");
				        $rs=mysql_query("select * from trandcareer where stream='$v'");
	 ...
	 <div class="col-sm-10 w3-card-2" style="background-color:#FFFFFF; padding-top:0px;">
	 <div class="w3-panel w3-teal">
<p><div align="center"><h4><b>ENGINEERING</b></h4></div></p></div>
     <p >This is the course where you are learning the technical things of all around the world.zncj dksF fkjAS sdJFkj S SE FFKJAS AS DKJSDF AS  SDJF J S F DFS JSD FJ JKSD F SD JSD FJSAD  JSE DS JF SD F  JDSF JS JS DFJ SDJ SJ JSDF JSFAD SDF SDF  SADFS L JFSD FSJDA
     </p><br />
	 
     <p><i><b>Pre Qualification :</b> Firs you must be passed 12th in science -math stream.</i></p><br />
     <p><b>Enter Exam : </b>JEE-MAIN,VIT,BITS etc</p>
     </div>
	 <div class="col-sm-1"></div>
