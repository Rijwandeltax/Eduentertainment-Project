...
<!--/main-header-->
 ...
 <!--//main-header-->
			...
			<!--//tv-movies-->
				...
				$rs=mysql_query("select * from showreview where genre='$v' AND typess='$ic' order by sn DESC");
				$num=10;
	...
	?>
				...
				<!--//requested-movies-->
					  <div class="blog-pagenat-wthree">
								<ul>
									...
									<li><button type="button" class="w3-btn last asd" id="<?=$num?>" id1="<?=$v?>" id2="<?=$ic?>" >Next</a></li>
								</ul>
				  ...
				  <h3 class="agile_w3_title"> Top Action show <span>Review</span></h3>
			<!--/movies-->				
			<div class="w3_agile_latest_movies">
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from showreview where genre='action'");
				while($r=mysql_fetch_array($rs)){
				if($i<10){
				$gh=$r[2];
				?>
