	 ...
	 <div class="banner-inner-dott">
		...
		<!--//header-w3l-->
			...
			<!--/content-inner-section-->
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from moviereview where genre='comedy' AND typess='$ic'");
			...
			<!--//comedy-movies-->
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from moviereview where genre='horror' AND typess='$ic'");
				while($r=mysql_fetch_array($rs)){
				if($i<6){
				$gh=$r[2];
				?>
			...
			<!--//tv-movies-->
				...
				$x=1;
		$rs=mysql_query("select * from moviereview where typess='$ic'");
		while($r=mysql_fetch_array($rs)){
		$x=$x+1;
		}
		$x=$x-1;
		$j=$x-10;
				...
				$rs=mysql_query("select * from moviereview where typess='$ic' order by sn DESC");
				$num=10;
	while($r=mysql_fetch_array($rs)){
	if($r[0]<=$x && $r[0]>$j){
         $gh=$r[2];
			...
			<div class="w3_agile_latest_movies">
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from moviereview where  typess='$ic' order by strating desc limit 0,10");
				while($r=mysql_fetch_array($rs)){
				if($i<10){
				$gh=$r[2];
				?>
