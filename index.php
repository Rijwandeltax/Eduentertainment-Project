	 ...
	 <div class="banner-inner-dott">
		...
		<!--//header-w3l-->
			...
			<!--/content-inner-section-->
				...
				<div class="w3_content_agilleinfo_inner"> 
					<div class="agile_featured_movies"> 
						<!--/agileinfo_tabs-->
				  <h3 class="agile_w3_title"> Latest <span>Movies & Shows</span></h3>
			<!--/movies-->				
			<div class="w3_agile_latest_movies"> 
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from trand order by sn DESC ");
			...
			<a href="full-story-trand.php?id=<?=$r[2]?>&event_id=<?=$r[1]?>" class="hvr-sweep-to-bottom"><img src="picss/<?=$r[2]?><?=$r[12]?>.jpg" title="Movies Pro" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
									<h6><a href="full-story-trand.php?id=<?=$r[2]?>&event_id=<?=$r[1]?>"><?=$r[2]?></a></h6>							
								</div>
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from news where typenews='Entertainment' order by sn DESC ");
				while($r=mysql_fetch_array($rs)){
				if($i<3){
				?>
		...
		<div class="w3-card" style="background-color:#FFFFFF; padding:3px 3px 3px 3px;">
			...
			<li style="font-weight:400; color:#003366">Entertainment</li>
			<li> Mobile&Book </li>
			<li>Career</li>
			</ul>
			...
			<div class="w3_agile_latest_movies">
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from trandcareer order by sn DESC ");
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from news where typenews='career' order by sn DESC");
				while($r=mysql_fetch_array($rs)){
				if($i<3){
				?>
		...
		<div class="w3-card" style="background-color:#FFFFFF; padding:3px 3px 3px 3px;">
			...
			<li>Entertainment</li>
			<li>Mobile&Book </li>
			<li style="font-weight:400; color:#003366">Career</li>
			</ul>
			<p style="font-family:'Lato', sans-serif; letter-spacing:1px"><?=$r[4]?></p>
			</div></div></div></div></div>
			<?php
