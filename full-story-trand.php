...
<!--/main-header-->
 ...
 <!--//main-header-->
				...
				$i=0;
				        ...
				        $rs=mysql_query("select * from trand where mname=$v AND title=$b");
			...
			<img src="picss/<?=$r[2]?><?=$r[12]?>.jpg" class="img-responsive" style="background-color:transparent; padding: .1em;">
			</div>	
			<div class="col-sm-5" style="margin-top:15px; padding-left:30px">
			<p style="margin-bottom:6px"><span>M</span>ovie:<?=$r[2]?></p>
			<p style="margin-bottom:6px"><span>R</span>ating:<?=$r[3]?></p>
			<p style="margin-bottom:6px"><span>S</span>tar <span>C</span>ast:<?=$r[4]?></p>
			<p style="margin-bottom:6px"><span>G</span>enre:<?=$r[6]?></p>
			<p style="margin-bottom:6px"><span>R</span>elesed:<?=$r[5]?></p>
			<p style="margin-bottom:6px"><span>L</span>ength:</p>
			<p style="margin-bottom:6px"><span>B</span>udget:</p>
			<p style="margin-bottom:6px"><span>R</span>eview:<?=$r[9]?></p>
			</div></div></div></div></div>
