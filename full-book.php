...
<!--/main-header-->
 ...
 <!--//main-header-->
				...
				$b=$_REQUEST["event_id"];
				include("enter.php");
				      $rs=mysql_query("select * from latest_movies where name= ");
			...
			<img src="images/m1.jpg" class="img-responsive" style="background-color:transparent; padding: .1em;">
			</div>	
			...
			<tr><td><span>Length</span></td>
			     <td>Lumia 535</td>
			</tr>
			<tr><td><span>width</span></td>
			     <td>Lumia 535</td>
			</tr>
			<tr><td><span>M</span>obile</td>
			     <td>Lumia 535</td>
			</tr>
			<tr><td><span>M</span>obile</td>
			     <td>Lumia 535</td>
