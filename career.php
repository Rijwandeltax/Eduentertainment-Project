 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner"  style="padding-top:2em">
					...
					<h1 style="text-align:left; font-size:30px; font-weight:700; color:#9ca3a9"><span>C</span>AREER</h1>
			...
			<div class="row">
		<a href="career-science.php"><div class="col-sm-4" style="padding:0px 30px 10px 20px">
		<img src="images/y.jpg" class="img-responsive" id="imgg">
		<!--	<p style="font-family:'Lato', sans-serif; font-style:italic; margin-top:5px; text-align:center">Aliquam sem velit, rhoncus sed arcu eu viverra. Suspendisse 						           lacus posuere.</p>-->
			<div id="learn">SCIENCE</div><br>
			</div></a>
			
		<!--	<a href="career-science.php"><div class="col-sm-4" style="padding:0px 30px 10px 20px">
		<img src="images/2.jpg" class="img-responsive" id="imgg">
			<p style="font-family:'Lato', sans-serif; font-style:italic; margin-top:5px; text-align:center">Aliquam sem velit, rhoncus sed arcu eu viverra. Suspendisse 						           lacus posuere.</p>
			<div id="learn">SCIENCE -BIO</div><br>
			</div></a>
-->



			<a href="career-arts.php">	<div class="col-sm-4" style="padding:0px 30px 10px 20px">
				<img src="images/y.jpg" class="img-responsive" id="imgg">
			<!--	<p style="font-family:'Lato', sans-serif; font-style:italic; margin-top:5px; text-align:center">Aliquam sem velit, rhoncus sed arcu eu viverra. Suspendisse 						           lacus posuere.</p>-->
				<div id="learn" >ARTS</div><br>
		</div></a>
		
				<a href="career-commerce.php"><div class="col-sm-4" style="padding:0px 30px 10px 20px">
					<img src="images/y.jpg" class="img-responsive" id="imgg">
				<!--	<p style="font-family:'Lato', sans-serif; font-style:italic; margin-top:5px; text-align:center">Aliquam sem velit, rhoncus sed arcu eu viverra. Suspendisse 						           lacus posuere.</p>-->
					<div id="learn" >COMMERCE</div><br>
					</div></a>
					<a href="after10th.php">	<div class="col-sm-4" style="padding:0px 30px 10px 20px">
				<img src="images/y.jpg" class="img-responsive" id="imgg">
			<!--	<p style="font-family:'Lato', sans-serif; font-style:italic; margin-top:5px; text-align:center">Aliquam sem velit, rhoncus sed arcu eu viverra. Suspendisse 						           lacus posuere.</p>-->
				<div id="learn" >AFTER 10TH CAREER </div><br>
		</div></a>
					<a href="after12th.php">	<div class="col-sm-4" style="padding:0px 30px 10px 20px">
				<img src="images/y.jpg" class="img-responsive" id="imgg">
			<!--	<p style="font-family:'Lato', sans-serif; font-style:italic; margin-top:5px; text-align:center">Aliquam sem velit, rhoncus sed arcu eu viverra. Suspendisse 						           lacus posuere.</p>-->
				<div id="learn" >AFTER 12TH CAREER</div><br>
		</div></a>
