	 ...
	 <div class="banner-inner-dott">
			   ...
			   <div class="header-w3-agileits" id="home">
				...
				<nav class="navbar navbar-default">
					<div class="navbar-header">
						...
						<h1><a  href="index.html"><span>E</span>du<span>E</span>ntertainment</a></h1>
					</div>
					<!-- navbar-header -->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<li class="active"><a href="mobile-review.php">Mobiles</a></li>
		...
		<!--//header-w3l-->
			...
			<!--/content-inner-section-->
				...
				<h3 class="agile_w3_title" style="margin-left:10%; color:#000000;"> <span>MOBILES</span></h3>
			...
			<div id="df">
			<a href="mobile-review-full-categary.php?id='Samsung'"><p class="text-center">Samsung</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px; ">
			<div id="df">
			<a href="mobile-review-full-categary.php?id='Apple'"><p class="text-center">Apple</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px; ">
			<div  id="df">
			<a href="mobile-review-full-categary.php?id='Microsoft'"><p class="text-center">Microsoft</p></a>
			</div></div>
			
			
			<div class="col-sm-4" style="padding-left:3px; ">
			<div  id="df">
			<a href="mobile-review-full-categary.php?id='Nokia'"><p class="text-center">Nokia</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px; ">
			<div  id="df">
			<a href="mobile-review-full-categary.php?id='Sony'"><p class="text-center">Sony</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='LG'"><p class="text-center">LG</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='HTC'"><p class="text-center">HTC</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Motorola'"><p class="text-center">Motorola</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Lenovo'"><p class="text-center">Lenovo</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Vivo'"><p class="text-center">Vivo</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Micromax'"><p class="text-center"> Micromax</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Oppo'"><p class="text-center"> Oppo</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Intex'"><p class="text-center">Intex</p></a>
			</div></div>
			
			<div class="col-sm-4" style="padding-left:3px;">
			<div  id="df">
						<a href="mobile-review-full-categary.php?id='Xiaomi'"><p class="text-center"> Xiaomi</p></a>
			</div></div>
			...
			<h3 class="agile_w3_title"> Latest <span>MOBILES</span></h3>
			<!--/movies-->				
			 <div class="wthree_agile-requested-movies">
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from mobilereview order by year DESC limit 0,10");
				...
				?>
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-slider ">
							<a href="full-story-mobile.php?id=<?=$r[1]?>" class="hvr-sweep-to-bottom"><img src="images/<?=$r[1]?><?=$r[15]?>.jpg" title="Movies Pro" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle-o" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
