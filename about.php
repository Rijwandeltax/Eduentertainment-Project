...
<h2 class="mtitle">WHAT IS THE EDUENTERTAINMENT</h2>

<p>
EDUENTERTAINMENT is a search engine which is helpful to everyone who want to know about <b>Movie review, TV review, Games review, Book review</b> and also helpful for students that aims to gets information about <b>Career</b> and various <b>Exam.</b>

<br />In Details,<br />
The Eduentertainment is a rating based site. We gave the rating on public opinions about various Movies, Television show, Games.
We also provide the information about latest mobile.
This search engine is helpful for students that aims to gets information about Career and various exam easily accessible to everyone.
This search engine is also helpful for book lovers. We gave the information about latest release books which is helpful to select good books.
</p>

<h2 class="mtitle">Our Team & Contact us</h2>
<p>
<b>
Rijwan Mohmmed,Abhishek Jarwal,Anuj Katara,Anil Agrawal,Ankit Swami,Ashish Lawasiya,Nitin Varandani
</b>
<br />We'd love to hear from you! Please send comments, inquiries, and suggestions to support.<br />
<a href="mailto:eduentertainment8@gmail.com">eduentertainment8@gmail.com</a>
</p>
</div></div></div></div>
					...
					<div class="footer-grids w3-agileits">
						...
						<h4>Pages</h4>
							<ul>
								...
								<li><a href="show-review.php?id='hindi'">HINDI SHOW </a></li>
								<li><a href="mobile-review">MOBILE  </a></li>
