...
<!--/main-header-->
 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from showreview where mname='$v'");
			...
			<img src="images/<?=$r[1]?><?=$r[11]?>.jpg" class="img-responsive" style="background-color:transparent; padding: .1em;">
			</div>	
			<div class="col-sm-5" style="margin-top:15px; padding-left:30px">
			<p style="margin-bottom:6px"><span>S</span>how:<?=$r[1]?></p>
			<p style="margin-bottom:6px"><span>R</span>ating:<div class="block-stars">
			...
			<p style="margin-bottom:6px"><span>S</span>tar <span>C</span>ast:<?=$r[3]?></p>
			<p style="margin-bottom:6px"><span>G</span>enre:<?=$r[5]?></p>
			<p style="margin-bottom:6px"><span>R</span>elesed:<?=$r[4]?></p>
			<p style="margin-bottom:6px"><span>D</span>irector:<?=$r[6]?></p>
			<!--<p style="margin-bottom:6px"><span>B</span>udget:<?=$r[]?></p>-->
			<p style="margin-bottom:6px"><span>R</span>eview:<?=$r[8]?></p>
			</div></div>
