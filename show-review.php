...
<script src="js/jquery.min.js"></script>
    ...
    window.location = "showsingle.php?id5="+v1+ "&id9="+v2;
});
         });
</script>
...
<!--/main-header-->
 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					<div class="agile_featured_movies">
									...
									<div class="col-sm-3">
				<select  class="form-control fg" name="id">
				...
				<option value=1 data-othervalue="Reality-TV" data-othervalue1="<?=$ic?>">Reality-TV</option>
				</select>
                  </div><br><br>
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from showreview where genre='comedy' AND typess='$ic'");
			...
			<!--//comedy-movies-->
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from showreview where genre='Horror' AND typess='$ic'");
				while($r=mysql_fetch_array($rs)){
				if($i<6){
				$gh=$r[2];
				?>
			...
			<!--//tv-movies-->
				...
				$x=1;
		$rs=mysql_query("select * from showreview where typess='$ic'");
		while($r=mysql_fetch_array($rs)){
		$x=$x+1;
		}
		$x=$x-1;
		$j=$x-10;
				...
				$rs=mysql_query("select * from showreview where typess='$ic' order by sn DESC");
				$num=10;
	while($r=mysql_fetch_array($rs)){
	if($r[0]<=$x && $r[0]>$j){
      $gh=$r[2];
				...
				<!--//requested-movies-->
					  <div class="blog-pagenat-wthree">
								<ul>
									...
									<li><button type="button" class="w3-btn last asd"  id="<?=$num?>" id3="<?=$ic?>">Next</button></li>
								</ul>
