...
<!--/main-header-->
 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				...
				include("enter.php");
				$i=0;
				$rs=mysql_query("select * from latest_movies where mname='$v' ");
			...
			<img src="images/1.jpg" class="img-responsive" style="background-color:transparent; padding: .1em;">
			</div>	
			<div class="col-sm-5" style="margin-top:15px; padding-left:30px">
			<p style="margin-bottom:6px"><span>M</span>ovie:</p>
			<p style="margin-bottom:6px"><span>R</span>ating:</p>
			<p style="margin-bottom:6px"><span>S</span>tar <span>C</span>ast:</p>
			<p style="margin-bottom:6px"><span>G</span>enre:</p>
			<p style="margin-bottom:6px"><span>R</span>elesed:</p>
			<p style="margin-bottom:6px"><span>L</span>ength:</p>
			<p style="margin-bottom:6px"><span>B</span>udget:</p>
			<p style="margin-bottom:6px"><span>R</span>eview:</p>
			</div></div>
