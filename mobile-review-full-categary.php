		...
		<!--//header-w3l-->
			...
			<!--/movies-->				
			 <div class="wthree_agile-requested-movies">
				...
				$i=0;
				$num=10;
				$rs=mysql_query("select * from mobilereview where company=$d order by year DESC ");
				...
				$rs=mysql_query("select * from mobilereview where company=$d order by year DESC limit 0,10");
				while($r=mysql_fetch_array($rs)){
				if($i<11){
				$i=$i+1;
				 $gh=$r[2];
