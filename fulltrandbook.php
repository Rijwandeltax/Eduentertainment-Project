...
<!--/main-header-->
 ...
 <!--//main-header-->
				...
				<?php
				if($_REQUEST["id"] || $_REQUEST["event_id"]){
				$v=$_REQUEST["id"];
				$b=$_REQUEST["event_id"];
				...
				include("enter.php");
				        ...
				        $rs=mysql_query("select * from trandshowbook where mobile-name=$v AND sn=$b");
			...
			<img src="images/<?=$r[2]?><?=$r[11]?>" class="img-responsive" style="background-color:transparent; padding: .1em;">
			</div>	
			...
			<tr><th>Feature</th>
			<th> Detail</th></tr>
			<tr><td><span>Book </span></td>
			     <td><?=$r[2]?></td>
			</tr>
			<tr><td><span>Genre</span></td>
			     <td><?=$r[6]?></td>
			</tr>
			<tr><td><span>Author</span></td>
			     <td><?=$r[11]?></td>
			</tr>
			<tr><td><span>Dimensation</span></td>
			     <td><?=$r[4]?></td>
			</tr>
			<tr><td><span>Language</span></td>
			     <td><?=$r[8]?></td>
			</tr>
			<tr><td><span>Year</span></td>
			     <td><?=$r[5]?></td>
			</tr>
			<tr><td><span>Publisher</span></td>
			     <td><?=$r[7]?></td>
			</tr>
			<tr><td><span>About</span></td>
			     <td><?=$r[9]?></td>
			</tr>
			...
			<div class="row">
			<div class="col-sm-3" style="padding-left:10px; padding-right:10px">
			<img src="picss/<?=$r[1]?><?=$r[15]?>.jpg" class="img-responsive" style="background-color:transparent; padding: .1em;">
			</div>	
			<div class="col-sm-1"></div>
			<div class="col-sm-5" style="margin-top:20px">
			<table class="w3-table w3-striped">
			<tr><th>Feature</th>
			<th> Detail</th></tr>
			<tr><td><span>Mobile Name </span></td>
			     <td><?=$r[2]?></td>
			</tr>
			<tr><td><span>Company</span></td>
			     <td></td>
			</tr>
			<tr><td><span>Rating</span></td>
			     <td>
			...
			<tr><td><span>Relesed</span></td>
			     <td><?=$r[5]?></td>
			</tr>
			<tr><td><span>OS</span></td>
			     <td><?=$r[4]?></td>
			</tr>
			<tr><td><span>RAM</span></td>
			     <td><?=$r[12]?></td>
			</tr>
			<tr><td><span>Front Camera</span></td>
			     <td><?=$r[11]?></td>
			</tr>
			<tr><td><span>Rear Camera</span></td>
			     <td><?=$r[7]?></td>
			</tr>
			<tr><td><span>Internal Memory</span></td>
			     <td><?=$r[8]?></td>
			</tr>
			<tr><td><span>Bettery</span></td>
			     <td><?=$r[13]?></td>
			</tr>
			<tr><td><span>Screen</span></td>
			     <td></td>
			</tr>
			<tr><td><span>Other Feature</span></td>
			     <td><?=$r[14]?></td>
			</tr>
			<tr><td><span>Review</span></td>
			     <td><?=$r[9]?></td>
			</tr>
