 ...
 <!--//main-header-->
		...
		<div class="col-sm-12" style="margin-top:0px; background:#fff;">		
			...
			<p><b>It</b> is a field which we can choose after 10th in the India. In this field, you can learn about:-
					<br />	
<p><b> It</b> is a Stream in which we can learn about life and living organism. In which we learn about structure, function, growth, etc. of living organism. <br />
Future aspects of this stream is that students of this stream can choose MBBS, B.sc etc. courses for their career.<br />
If you are interested in studying the nature of plants and animals then in this 
</p>
