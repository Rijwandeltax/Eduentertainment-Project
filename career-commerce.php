 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner"  style="padding-top:2em">
					...
					<h1 style="text-align:left; font-size:30px; font-weight:700; color:#9ca3a9"><span>C</span>OMMERCE</h1>
		...
		<div class="col-sm-12" style="margin-top:0px; background:#fff;">		
			...
			<p><div align="center"><h3><b>Commerce</b></h3></div></p></div>
			
            <div style="padding-left:3%; padding-right:3%">
			<p><b>It</b> is a field which we can choose after 10th in the India. In this field, you can learn about:-
					<br />	
					<p>Commerce is the Stream mainly for those who are interested in business Administration and Accountability .It also deals with subjects such as economics , accountancy business studies, statistics.</p> 
