				            ...
				            <div class="inner-agile-w3l-part-head">
							   ...
							   <div class="latest-news-agile-info">
										 ...
										 $i=$i+1;
											...
											<div class="w3-agileits-news-one">
												<div class="wthree-news-img">
													<a href="full-story-news.php?id=<?=$r[0]?>"><img src="images/<?=$r[1]?><?=$r[0]?>.jpg" alt=""></a>
												</div>
												<div class="wthree-news-info">
													<h5><a href="full-story-news.php?id=<?=$r[0]?>"><?=$r[2]?></a></h5>
													<div class="agile-post">
															<p> on	<?=$r[6]?> with </p>
														</div>
														<p><?=$r[4]?></p>
														<a class="new-more" href="full-story-news.php?id=<?=$r[0]?>">Read More</a>
												</div>
												<div class="clearfix"> </div>
								...
								<ul>
									...
									<li><button type="button" class="w3-btn asd last" id="<?=$num?>">Next</button></li>
								</ul>
							</div><!--riju-->
											</div>
											<!--riju-->
